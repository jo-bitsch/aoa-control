...
class TransformPassKeyToSSHKeyTest {
    ...
    fun handleCreatePublicKeyResponse2() {
        ...
        val testResponse = CreatePublicKeyCredentialResponse(
            """
            {
              ...
              "response": {
                "clientDataJSON": "eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoibHV3ZTkwVlJVZGMtUzg3YmExdEhLRVRaemVyQmJuVzhPd3RWZVZpUGMzZyIsIm9yaWdpbiI6Imh0dHBzOi8vd3d3Lm1pbmRyb3Qub3JnIiwiY3Jvc3NPcmlnaW4iOmZhbHNlfQ==",
                "attestationObject": "c-Bc19gFo6-gU02dlq4mtGAXqQvT1Q0lC8kiWCCJ1EcMe3YJLGk1oThNqTCvPMdsjVgoNJ4ykwsR7tM9rw=="
              }
            }
        """.trimIndent()
        )
        ...
        @Suppress("SpellCheckingInspection")
        assert(sshKey.startsWith("sk-ecdsa-sha2-nistp256@openssh.com AAAAInNrLWVjZHNhLXNoYTItbmlzdHAyNTZAb3BlbnNzaC5jb20AAAAIbmlzdHAyNTYAAABBBCouPRsj1+vgXNfYBaOvoFNNnZauJrRgF6kL09UNJQvJidRHDHt2CSxpNaE4TakwrzzHbI1YKDSeMpMLEe7TPa8AAAAPd3d3Lm1pbmRyb3Qub3Jn"))
    ...
    fun handleSigParsing2() {
        ...
        @Suppress("SpellCheckingInspection")
        val expected = ""
        assertEquals(expected, result)
    }
